  ...
  function handleCreate() {
    startSaving(async () => {
      try {
        ...
        toast.error(
          error instanceof Error ? error.message : "Failed to create developer"
        )
      }
    })
  }
    ...
    >
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a developer manually. Shown on the public developers page — the
            cover image appears on the developer&apos;s card and the description
            is the write-up beneath it.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="new-developer-description">Description</Label>
            <Textarea
              id="new-developer-description"
              value={description}
          ...
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="new-developer-website">Website (optional)</Label>
            <Input
              id="new-developer-website"
              value={websiteUrl}
